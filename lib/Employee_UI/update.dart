...
class edit extends StatefulWidget {
  ...
  final String phone;
  final String name;
  const edit({super.key, required this.email, required this.phone,required this.name});
...
class _editState extends State<edit> {
  ...
  void initState() {
    super.initState();
    _currentUserName = widget.name.isEmpty ? 'أحمد خالد محمود علي' : widget.name;
    _currentUserEmail = widget.email.isEmpty ? 'ahmadAli@employee.gov.jo' : widget.email;
    _currentUserPhone = widget.phone.isEmpty ? '0791112233' : widget.phone;
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              _buildTextField(
                ...
                hintText: 'ahmadAli@employee.gov.jo',
